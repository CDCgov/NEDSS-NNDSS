...
class DataExchangeGenericServiceTest {
    ...
    void testGetTotalRecord_Success_RDB() throws DataExchangeException {
        ...
        // Act
        Integer result = dataExchangeGenericService.getTotalRecord(tableName, initialLoad, timestamp, false);
    ...
    void testGetTotalRecord_Failure_NoTableFound() {
        ...
        // Act & Assert
        assertThrows(DataExchangeException.class, () -> dataExchangeGenericService
                .getTotalRecord(tableName, initialLoad, timestamp, false));
    }
