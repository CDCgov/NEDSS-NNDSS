    ...
    BEGIN
        ...
        VALUES
            ('D_INV_RISK_FACTOR', 'RDB',
             'SELECT D_INV_RISK_FACTOR.* FROM D_INV_RISK_FACTOR WHERE D_INV_RISK_FACTOR_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_RISK_FACTOR WHERE D_INV_RISK_FACTOR_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_RISK_FACTOR.*, ROW_NUMBER() OVER (ORDER BY D_INV_RISK_FACTOR.D_INV_RISK_FACTOR_KEY) AS RowNum FROM D_INV_RISK_FACTOR  WHERE D_INV_RISK_FACTOR_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
    END;
    ...
    BEGIN
        ...
        VALUES
            ('D_INV_ADMINISTRATIVE', 'RDB',
             'SELECT D_INV_ADMINISTRATIVE.* FROM D_INV_ADMINISTRATIVE  WHERE D_INV_ADMINISTRATIVE_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_ADMINISTRATIVE FROM D_INV_ADMINISTRATIVE  WHERE D_INV_ADMINISTRATIVE_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_ADMINISTRATIVE.*, ROW_NUMBER() OVER (ORDER BY D_INV_ADMINISTRATIVE.D_INV_ADMINISTRATIVE_KEY) AS RowNum FROM FROM D_INV_ADMINISTRATIVE  WHERE D_INV_ADMINISTRATIVE_KEY :operator :timestamp ) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
    ...
    BEGIN
        ...
        VALUES
            ('D_INV_EPIDEMIOLOGY', 'RDB',
             'SELECT D_INV_EPIDEMIOLOGY.* FROM D_INV_EPIDEMIOLOGY WHERE D_INV_EPIDEMIOLOGY_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_EPIDEMIOLOGY WHERE D_INV_EPIDEMIOLOGY_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_EPIDEMIOLOGY.*, ROW_NUMBER() OVER (ORDER BY D_INV_EPIDEMIOLOGY.D_INV_EPIDEMIOLOGY_KEY) AS RowNum FROM D_INV_EPIDEMIOLOGY WHERE D_INV_EPIDEMIOLOGY_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
...
IF
    ...
    BEGIN
        ...
        VALUES
            ('D_INV_HIV', 'RDB',
             'SELECT D_INV_HIV.* FROM D_INV_HIV WHERE D_INV_HIV_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_HIV WHERE D_INV_HIV_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_HIV.*, ROW_NUMBER() OVER (ORDER BY D_INV_HIV.D_INV_HIV_KEY) AS RowNum FROM D_INV_HIV WHERE D_INV_HIV_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
    ...
    BEGIN
        ...
        VALUES
            ('D_INV_LAB_FINDING', 'RDB',
             'SELECT D_INV_LAB_FINDING.* FROM D_INV_LAB_FINDING WHERE D_INV_LAB_FINDING_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_LAB_FINDING WHERE D_INV_LAB_FINDING_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_LAB_FINDING.*, ROW_NUMBER() OVER (ORDER BY D_INV_LAB_FINDING.D_INV_LAB_FINDING_KEY) AS RowNum FROM D_INV_LAB_FINDING WHERE D_INV_LAB_FINDING_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
    ...
    BEGIN
        ...
        VALUES
            ('D_INV_MEDICAL_HISTORY', 'RDB',
             'SELECT D_INV_MEDICAL_HISTORY.* FROM D_INV_MEDICAL_HISTORY WHERE D_INV_MEDICAL_HISTORY_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_MEDICAL_HISTORY WHERE D_INV_MEDICAL_HISTORY_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_MEDICAL_HISTORY.*, ROW_NUMBER() OVER (ORDER BY D_INV_MEDICAL_HISTORY.D_INV_MEDICAL_HISTORY_KEY) AS RowNum FROM D_INV_MEDICAL_HISTORY WHERE D_INV_MEDICAL_HISTORY_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
...
IF
    ...
    BEGIN
        ...
        (table_name, source_db, query, query_with_null_timestamp, query_count, query_with_pagination)
        VALUES
            ('D_INV_TREATMENT', 'RDB', 'SELECT D_INV_TREATMENT.* FROM D_INV_TREATMENT WHERE D_INV_TREATMENT_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_TREATMENT WHERE D_INV_TREATMENT_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_TREATMENT.*, ROW_NUMBER() OVER (ORDER BY D_INV_TREATMENT.D_INV_TREATMENT_KEY) AS RowNum FROM D_INV_TREATMENT WHERE D_INV_TREATMENT_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
    ...
    BEGIN
        ...
        VALUES
            ('D_INV_VACCINATION', 'RDB',
             'SELECT D_INV_VACCINATION.* FROM D_INV_VACCINATION WHERE D_INV_VACCINATION_KEY :operator :timestamp;',
             NULL,
             'SELECT COUNT(*) FROM D_INV_VACCINATION WHERE D_INV_VACCINATION_KEY :operator :timestamp;',
             'WITH PaginatedResults AS (SELECT D_INV_VACCINATION.*, ROW_NUMBER() OVER (ORDER BY D_INV_VACCINATION.D_INV_VACCINATION_KEY) AS RowNum FROM D_INV_VACCINATION  WHERE D_INV_VACCINATION_KEY :operator :timestamp) SELECT * FROM PaginatedResults WHERE RowNum BETWEEN :startRow AND :endRow;');
