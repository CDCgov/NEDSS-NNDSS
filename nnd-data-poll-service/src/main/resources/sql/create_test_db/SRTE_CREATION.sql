-- Program_area_code definition

-- Drop table

-- DROP TABLE Program_area_code;
...
-- Condition_code foreign keys

ALTER TABLE Condition_code ADD CONSTRAINT FK_Condition_code336 FOREIGN KEY (prog_area_cd) REFERENCES Program_area_code(prog_area_cd);


-- Code_to_condition definition

-- Drop table

-- DROP TABLE Code_to_condition;

CREATE TABLE Code_to_condition (
...
-- Jurisdiction_code definition

-- Drop table

-- DROP TABLE Jurisdiction_code;
