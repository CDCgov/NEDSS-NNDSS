...
CREATE  UNIQUE NONCLUSTERED INDEX UQ__Condition_code__276EDEB3 ON NBS_SRTE.dbo.Condition_code (  nbs_uid ASC  )
...
CREATE  UNIQUE NONCLUSTERED INDEX UQ__Program_area_cod__5441852A ON NBS_SRTE.dbo.Program_area_code (  nbs_uid ASC  )
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 90   ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
