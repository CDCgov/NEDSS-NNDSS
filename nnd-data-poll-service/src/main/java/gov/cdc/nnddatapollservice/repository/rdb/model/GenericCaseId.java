...
@Setter
@Embeddable
public class GenericCaseId implements Serializable {
    private static final long serialVersionUID = 8563676571925939796L;
    ...
    public boolean equals(Object o) {
        ...
        GenericCaseId entity = (GenericCaseId) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(investigatorKey, investigationKey, conditionKey, physicianKey, ldfGroupKey, patientKey, invAssignedDtKey, rptSrcOrgKey, adtHsptlKey, reporterKey);
    }
