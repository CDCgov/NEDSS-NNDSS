...
@Setter
@Embeddable
public class PertussisCaseId implements Serializable {
    private static final long serialVersionUID = -5455593190446713777L;
    ...
    @jakarta.validation.constraints.NotNull
    @Column(name = "PERTUSSIS_SUSPECT_SRC_GRP_KEY", nullable = false)
    private Long pertussisSuspectSrcGrpKey;

    @jakarta.validation.constraints.NotNull
    @Column(name = "PERTUSSIS_TREATMENT_GRP_KEY", nullable = false)
    private Long pertussisTreatmentGrpKey;
    ...
    public boolean equals(Object o) {
        ...
        PertussisCaseId entity = (PertussisCaseId) o;
        return Objects.equals(this.pertussisSuspectSrcGrpKey, entity.pertussisSuspectSrcGrpKey) &&
                Objects.equals(this.investigatorKey, entity.investigatorKey) &&
                Objects.equals(this.investigationKey, entity.investigationKey) &&
                Objects.equals(this.pertussisTreatmentGrpKey, entity.pertussisTreatmentGrpKey) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pertussisSuspectSrcGrpKey, investigatorKey, investigationKey, pertussisTreatmentGrpKey, conditionKey, physicianKey, ldfGroupKey, patientKey, rptSrcOrgKey, invAssignedDtKey, adtHsptlKey, reporterKey);
    }
