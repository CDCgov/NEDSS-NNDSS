...
@Setter
@Embeddable
public class MeaslesCaseId implements Serializable {
    private static final long serialVersionUID = 6522530383463463998L;
    ...
    public boolean equals(Object o) {
        ...
        MeaslesCaseId entity = (MeaslesCaseId) o;
        return Objects.equals(this.investigatorKey, entity.investigatorKey) &&
                ...
                Objects.equals(this.invRptDtKey, entity.invRptDtKey) &&
                Objects.equals(this.reporterKey, entity.reporterKey);
    }

    @Override
    public int hashCode() {
        return Objects.hash(investigatorKey, investigationKey, conditionKey, physicianKey, ldfGroupKey, patientKey, invAssignedDtKey, rptSrcOrgKey, adtHsptlKey, invRptDtKey, reporterKey);
    }
